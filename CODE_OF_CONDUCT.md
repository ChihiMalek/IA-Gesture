...
diverse, inclusive, and healthy community — in a spirit consistent with this
project's mission of building **accessible technology for people with
disabilities**.
...
reported to the project maintainers privately via GitHub — either by
opening a [Security Advisory](../../security/advisories/new) (treated
confidentially) or by contacting a maintainer directly through the GitHub
profile linked in the [Authors section of the README](README.md#-authors).
